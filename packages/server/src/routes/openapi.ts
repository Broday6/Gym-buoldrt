...
const DOCS: Record<string, { tag: string; summary: string }> = {
  ...
  'GET /v1/:site/analytics/diagnose': { tag: 'Analytics', summary: 'Searches wasting traffic, each with a diagnosis and a suggested fix' },
  'GET /v1/:site/analytics/terms': { tag: 'Analytics', summary: 'What each word in the query log means to shoppers, by what they click' },
  ...
  'GET /v1/:site/admin/experiments': { tag: 'Merchandising', summary: 'Experiments and what they have measured so far' },
  'POST /v1/:site/admin/experiments': { tag: 'Merchandising', summary: 'Split traffic on a rule to find out whether it helps' },
  'POST /v1/:site/admin/experiments/:id/end': { tag: 'Merchandising', summary: 'Keep or discard the change an experiment tested' },
  'GET /v1/:site/admin/proposals': { tag: 'Merchandising', summary: 'Merchandising the system proposes from measured behaviour' },
  'POST /v1/:site/admin/proposals/apply': { tag: 'Merchandising', summary: 'Carry out a proposal, recorded and revertible' },
  'POST /v1/:site/admin/proposals/dismiss': { tag: 'Merchandising', summary: 'Stop offering a proposal' },
  'GET /v1/:site/admin/query-rules': { tag: 'Merchandising', summary: 'Rules bound to what a shopper typed' },
  'POST /v1/:site/admin/query-rules': { tag: 'Merchandising', summary: 'Pin, bury or hide products for a search term' },
  'DELETE /v1/:site/admin/query-rules/:id': { tag: 'Merchandising', summary: 'Delete a query rule' },
  'POST /v1/:site/admin/query-rules/preview': { tag: 'Merchandising', summary: 'The grid as it would look with unsaved changes applied' },
